...
func main() {
    var (
        signerPrivateKeyHex string = "4f3c8a1d9e7b2c6f5a0d3e8b1c7f9a2d6e4b0c3a8f1d5e7b9c2a6f4d8e0b3c1"
        rpcURL string = "https://alchemy.io"
        chainID *big.Int = big.NewInt(31331)
        escrowRouterAddress = common.HexToAddress("0xFEEEEEE44046c3f61a8CC081E0918eF0de0a7ffC")
        value *big.Int = big.NewInt(0)
        dataHex string = "0x2c343229111111125421ca6dc452d289314280a0f8842a65"
        nonce uint64 = 42
        gasLimit uint64 = 101
        maxPriorityFeePerGas *big.Int = big.NewInt(105)
        maxFeePerGas *big.Int = big.NewInt(11)
    )
